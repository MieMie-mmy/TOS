    ...
    public class Company_EntryBL
    {
        ...
        public DataTable UpdateCompany(M_CompanyModel mModel, string PcName)
        {
            ...
            if (mModel != null)
            {
                ...
                prms[13] = new SqlParameter("@updateOperator", SqlDbType.VarChar) { Value = mModel.UpdateOperator };

                prms[14] = new SqlParameter("@AccessPC", SqlDbType.VarChar) { Value = PcName };

                dl.InsertUpdateDeleteData("M_Company_Update", prms);
            }
            return dt;
        }
        ...
        public DataTable UpdateCompanyBrand(M_BrandModel mBrand, M_CompanyModel mModel, string PcName)
        {
            ...
            if (mBrand != null)
            {
                ...
                prmBrand[2] = new SqlParameter("@UpdateOperator", SqlDbType.VarChar) { Value = mBrand.UpdateOperator };
                prmBrand[3] = new SqlParameter("@AccessPC", SqlDbType.VarChar) { Value = PcName };
