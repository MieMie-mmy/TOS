...
namespace TOS_Model
{
    public class T_OrderHistoryModel
    {
        ...
        public string OrderDateTime_h { get; set; }
        public DateTime? AvailableShippingDate { get; set; }
        public DateTime? OrderDateTime_d { get; set; }
    ...
    public class T_OrderHistoryModel2
    {
        ...
        public string OrderDate_gav { get; set; }
        public string OrderTime_gav { get; set; }
        public DateTime? ShippingDate_gav { get; set; }
        public string Memo_gav { get; set; }


    }
    public class T_OrderHistorySearch
     {
        public string id { get; set; }
        public string o_f { get; set; }
        public string o_t { get; set; }
